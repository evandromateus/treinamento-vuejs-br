<template>
  ...
  <div class="flex flex-col items-center justify-center h-64 bg-brand-gray">
    <h1 class="text-4xl font-black text-center text-gray-800 mb-2">Feedbacks</h1>
    ...
    <div class="w-4/5 max-w-6xl py-10 grid grid-cols-4 gap-2">
      <div class="">
        ...
        <suspense>
          ...
          <template #fallback>
            <filters-loading class="mt-11"/>
          </template>
        </suspense>
      </div>
      <div class="py-10 pt-20 col-span-3">
        <p v-if="state.hasError" class="text-lg text-center text-gray-800 font-regular">
          Aconteceu um erro ao carregar os feedbacks :(
        </p>
        <p v-if="!state.feedbacks.length && !state.isLoading && !state.isLoadingMoreFeedbacks && !state.hasError" class="text-lg text-center text-gray-800 font-regular">
